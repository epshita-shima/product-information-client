            ...
            <div className='grid grid-cols-2 gap-4 items-center mt-10'>
                <div class="dropdown">
                    ...
                    <ul tabindex="0" class="dropdown-content menu p-2 shadow bg-white text-black rounded-box w-full">
                        ...
                        {
                            infoList.map(category => <li className='hover:bg-[#4b5320] hover:text-white mb-2 p-2 border'>{category.categoryData}</li>)
                        }

                    </ul>
                </div>
                <div class="dropdown">
                    <label tabindex="0" class="btn-ghost bg-gray-200 m-1 p-3 text-black block text-center">Unit name <FontAwesomeIcon className='text-black ml-2 text-xl text-center' icon={faSortDown}></FontAwesomeIcon></label>
                    <ul tabindex="0" class="dropdown-content menu p-2 shadow bg-white text-black  rounded-box w-full">
                        {
